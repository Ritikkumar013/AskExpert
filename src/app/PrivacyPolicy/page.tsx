...
const PrivacyPolicy = () => {
  return (
    <>
    <div className='w-full h-[55vh] md:h-[70vh] flex items-center bg-[url("/1.jpg")] bg-cover bg-center lg:h-[80vh]'>
                <div className="container px-5 flex flex-col items-start max-w-[1280px] mx-auto gap-[10px] text-white md:px-10 lg:mb-[-80px]">
            ...
            {/* Section 2 */}
            <div className='bg-white text-sm py-14 px-5'>

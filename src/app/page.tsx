...
export default function Home() {
  ...
  return (
    <>
      {/* Section 1 */}
      <div className="bg-gradient-to-b from-[#ffe3e3] pt-12 p-3">
        <div className="container flex flex-col md:flex-row max-w-screen-xl mx-auto items-center p-4">
          ...
          <div className="basis-1/2 mt-6 md:mt-0">
            <Image
              ...
              className="ml-auto w-full max-w-[400px] object-cover"
            />
          </div>
        </div>
      </div>
      ...
      {/* Section 2 */}
      <div className="w-full  pb-14 md:pt-[20px] sm:[8px]">
        <div className="text-center mb-12">
          <h3 className="text-3xl md:text-4xl font-bold mb-4">
            Trusted By <span className="text-[#dc143c]">500+ Leading </span>
            Brands
          </h3>
          <p className="max-w-3xl mx-auto">Delivering measurable outcomes</p>
        </div>
        <div className="w-full overflow-hidden">
          <div
            className="flex w-[200%] md:w-[140%] justify-between items-center"
            style={{
              transform: `translateX(${scrollPosition * 0.5 - 300}px)`,
              transition: "transform 0.1s linear",
            }}
          >
            {["sugar", "mindvalley", "jenna", "nike", "amy", "hotmart", "benefit"].map((brand) => (
              <Image
                key={brand}
                src={`/${brand}.png`}
                alt={`${brand} logo`}
                width={50}
                height={50}
                className="w-auto h-24 hext-center "
              />
            ))}
          </div>
        </div>
      ...
      {/* Section 3 */}
      <div className="w-full lg:py-[20px] md:py-[20px]  sm:py-[10px]">
        <div className="text-center mb-12 p-5 text-xl">
        ...
        <div className="container flex flex-col md:flex-row items-center max-w-[1100px] mx-auto bg-black justify-between rounded-2xl">
          ...
          <div className="basis-1/2">
            <Image
              className="ml-auto rounded-r-2xl w-full max-w-[470px]"
